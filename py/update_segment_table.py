    ...
    try:
        ...
        cursor.execute("""
            CREATE TABLE IF NOT EXISTS segments (
                ...
                UNIQUE KEY idx_chapter_segment (chapter_id, segment_number),
